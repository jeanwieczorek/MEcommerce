...
public class FragmentUsuario extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_cadastro_usuarios, container, false);

        recyclerView = (RecyclerView)view.findViewById(R.id.activity_cadastro_usuarios_cpf);
