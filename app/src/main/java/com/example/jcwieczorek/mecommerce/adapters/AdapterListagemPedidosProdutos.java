...
public class AdapterListagemPedidosProdutos extends RecyclerView.Adapter<HolderListagemProdutos> implements View.OnClickListener, IItemClickListener{

    private List<Produto> produtos;
    private Context contexto;

    public AdapterListagemPedidosProdutos(List<Produto> produtos, Context contexto) {
